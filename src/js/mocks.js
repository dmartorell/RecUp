export const MOCK_CARDS = [
  {
    is_bug: true,
    rawTranscript:
      'en la sección de consumos energéticos las gráficas de electricidad del último mes no cargan se quedan en blanco y si cambias a la vista semanal tampoco aparecen los datos solo se ve el eje vertical sin ninguna barra.',
    transcript:
      'en la sección de consumos energéticos las gráficas de electricidad del último mes no cargan se quedan en blanco y si cambias a la vista semanal tampoco aparecen los datos solo se ve el eje vertical sin ninguna barra.',
  ...
  },
  {
    is_bug: true,
    rawTranscript:
      'un inquilino nos ha reportado que al intentar abrir la puerta del parking desde la app le sale un error de timeout y tiene que reintentar tres o cuatro veces hasta que finalmente se abre pero tarda bastante más de lo normal.',
    transcript:
      'un inquilino nos ha reportado que al intentar abrir la puerta del parking desde la app le sale un error de timeout y tiene que reintentar tres o cuatro veces hasta que finalmente se abre pero tarda bastante más de lo normal.',
  ...
  },
  {
    is_bug: true,
    rawTranscript:
      'en la app de inquilinos cuando le das a programar el encendido de la calefacción se guarda la hora pero luego no se ejecuta a la hora programada y el inquilino tiene que encenderla manualmente cada vez.',
    transcript:
      'en la app de inquilinos cuando le das a programar el encendido de la calefacción se guarda la hora pero luego no se ejecuta a la hora programada y el inquilino tiene que encenderla manualmente cada vez.',
